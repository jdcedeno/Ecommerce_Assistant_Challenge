...
# Parse completion.choices[0].message["content"] and run the tools.
# Run the model again, this time giving it instructions to answer the query based on the information in it's context (the results from each tool call)